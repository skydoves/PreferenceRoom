...
public class PreferenceEntityGenerator {
    ...
    public TypeSpec generate() {
        TypeSpec.Builder classBuilder = TypeSpec.classBuilder(getClazzName())
    ...
    private MethodSpec getConstructorSpec() {
        return MethodSpec.constructorBuilder()
                ...
                .addStatement("$N = $N.getApplicationContext().getSharedPreferences($S, Context.MODE_PRIVATE)", FIELD_PREFERENCE, CONSTRUCTOR_CONTEXT, annotatedClazz.preferenceName)
                .build();
    }
